 ...
 * @param {Point} ep 终点
 */
draw_Curve_2(pointset){
// 定义起点、控制点和结束点的坐标
const startX = pointset[0].x
const startY = pointset[0].y
const controlX = pointset[1].x
const controlY = pointset[1].y
const endX = pointset[2].x
const endY = pointset[2].y
// 绘制二次曲线
this.ctx.beginPath();
